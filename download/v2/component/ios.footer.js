Vue.component('ios-install-footer', {
    props: ['betatitle', 'storetitle', 'tftitle', 'i18nsupport', 'installtitle', 'installsubtitle', 'installbetatitle', 'installbetasubtitle'],
    data: function () {
        return {
        }
    },
    ...
    <template v-else-if="betatitle && storetitle && i18nsupport">
