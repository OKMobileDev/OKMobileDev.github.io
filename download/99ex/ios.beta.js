new Vue({
    ...
    data: function () {
        return {
            ...
            setp_2_tips_2_3: '找到 99EX 内测版的证书并点击信任，即可使用 99EX',
            credit_step_1_img: './images/ios-beta-credit-setp-1.png',
            credit_step_2_img: './images/ios-beta-credit-setp-2.png',
            iosBetaDownloadURL: 'itms-services://?action=download-manifest&url=https://upgradeapp.oss-cn-hangzhou.aliyuncs.com/upgradeapp/install-99ex-manifest.plist',
            tipsData: [
