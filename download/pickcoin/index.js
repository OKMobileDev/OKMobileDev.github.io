new Vue({
    ...
    data: function () {
        return {
            ...
            headerSubtitle: '',
            androidInstallTitle: '立即安装 PICK COIN',
            betaTitle: '立即安装 PICK COIN',
            storeTitle: false,
            logo: './images/header-logo.png',
            androidDownloadURL: 'http://upgradeapp.oss-cn-hangzhou.aliyuncs.com/upgradeapp/PickCoin-android.apk',
            tipsData: [{
