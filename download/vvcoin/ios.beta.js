new Vue({
    ...
    data: function () {
        return {
            ...
            iosBetaDownloadURL: 'itms-services://?action=download-manifest&url=https://ok-public-hk.oss-cn-hongkong.aliyuncs.com/upgradeapp/install-vvcoin-manifest.plist',
            tipsData: [
